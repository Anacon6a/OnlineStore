<div class="span3">
	<div class="sidebar">
		...
		<ul class="widget widget-menu unstyled">
			...
			<li><a href="insert-product.php"><i class="menu-icon icon-paste"></i>Добавление товаров </a></li>
			<li><a href="manage-products.php"><i class="menu-icon icon-table"></i>Товары </a></li>
		</ul>
