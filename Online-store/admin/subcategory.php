...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$_SESSION['msg'] = "Подкатегория создана!";
	}
...
?>
	...
	<head>
		...
		<title>Администратор| Подкатегории</title>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name="category" class="span8 tip" required>
													<option value="">Выберите катагорию</option>
											...
											?>
												<tr>
													...
													<td>
														...
														<a href="subcategory.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Удалить?')"><i class="icon-remove-sign"></i></a>
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
											} ?>
