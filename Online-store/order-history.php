...
?>
	...
	<head>
		...
		<title>TheMad_Store | Аккаунт | История заказов</title>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']); ?>');" title="Информация о заказе">
															Отследить
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
