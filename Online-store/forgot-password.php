...
if (isset($_POST['change'])) {
	...
	if ($num > 0) {
		...
		$_SESSION['errmsg'] = "Пароль успешно изменён";
		exit();
	} else {
		$extra = "forgot-password.php";
		$host  = $_SERVER['HTTP_HOST'];
		$uri  = rtrim(dirname($_SERVER['PHP_SELF']), '/\\');
		header("location:http://$host$uri/$extra");
		$_SESSION['errmsg'] = "Неправильный Email или номер телефона";
		exit();
	}
}
?>
...
<head>
	...
	<title>TheMad_Store | Восстановление пароля</title>
			...
			<div class="sign-in-page inner-bottom-sm">
				<div class="row">
					<div class="col-md-6 col-sm-6 sign-in">
						<h4 class="">Восстановление пароля</h4>
						<form class="register-form outer-top-xs" name="register" method="post">
							...
							<div class="form-group">
								<label class="info-title" for="exampleInputPassword1">Номер телефона <span>*</span></label>
							...
							<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Восстановить </button>
						</form>
					</div>
				</div>
			</div>
