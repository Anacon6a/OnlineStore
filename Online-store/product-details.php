...
<head>
	...
	<title>TheMad_Store | Подробнее о продукте</title>
									...
									<div id="owl-single-product">
										<div class="single-product-gallery-item" id="slide1">
											<a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']); ?>" href="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>">
												<img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" width="150" height="250" />
											</a>
										</div>
										<div class="single-product-gallery-item" id="slide1">
											<a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']); ?>" href="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>">
								...
								<div class="product-info">
									...
									?>
										<div class="rating-reviews m-t-20">
											<div class="row">
												...
												<div class="col-sm-6">
													<div class="reviews">
														<a href="#" class="lnk">(Отзывы: <?php echo htmlentities($num); ?> )</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="stock-container info-container m-t-10">
										<div class="row">
											<div class="col-sm-5">
												<div class="stock-box">
													<span class="label">Брэнд продукта :</span>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="stock-box">
											...
											<div class="col-sm-6">
												<div class="stock-box">
													<span class="value"><?php if ($row['shippingCharge'] == 0) {
																			...
																			echo htmlentities($row['shippingCharge']); ?>Руб.
													<?php }
													?></span>
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="favorite-button m-t-10">
													<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="В избранное" href="product-details.php?pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist">
													...
													?>
														<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
															<div class="review">
																...
																<div class="text"><b>Качество :</b> <?php echo htmlentities($rvw['quality']); ?></div>
																<div class="text"><b>Стоимость :</b> <?php echo htmlentities($rvw['price']); ?></div>
																<div class="text"><b>Достоинства :</b> <?php echo htmlentities($rvw['value']); ?></div>
															...
															<div class="table-responsive">
																<table class="table table-bordered">
																	...
																	<tbody>
																		...
																		<tr>
																			<td class="cell-label">Стоимость</td>
																		...
																		<tr>
																			<td class="cell-label">Достоинства </td>
														...
														<div class="review-form">
															<div class="form-container">
																<div class="row">
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label for="exampleInputName">Имя <span class="astk">*</span></label>
																			<input type="text" class="form-control txt" id="exampleInputName" placeholder="" name="name" required="required">
																		</div>
																		<div class="form-group">
																			<label for="exampleInputSummary">Заголовок <span class="astk">*</span></label>
																...
																<div class="action text-right">
																	<button name="submit" class="btn btn-primary btn-upper">ОПУБЛИКОВАТЬ ОТЗЫВ</button>
																</div>
												</form>
											</div>
										</div>
