...
<head>
	...
	<title>TheMad_Store | Подкатегории</title>
				...
				<div class='col-md-9'>
					<div class="container-fluid">
						<div class="caption vertical-top text-left">
							...
							while ($row = mysqli_fetch_array($sql)) {
							?>
								<div class="excerpt hidden-sm hidden-md  text-center">
								...
								<div class="row row-flex" style="display: flex; flex-flow: row wrap">
									...
									if ($num > 0) {
															...
															<div class="action">
																<ul class="list-unstyled">
																	...
																	<li class="lnk wishlist">
																		<a class="add-to-cart" href="sub-category.php?pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist" title="В избранное">
										...
										<div class="col-sm-6 col-md-4 wow fadeInUp">
											<h3>В этой подкатегории пока нет товаров</h3>
										</div>
									<?php } ?>
								</div>
							</div>
